...
namespace Disconnected_Environment
{
    public partial class FormDataStatusMahasiswa : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string queryStrings = "select Nax(id_status) from dbo.status_mahasiswa";
            ...
            MessageBox.Show("Data Berhasul Disimpan", "Sukses", MessageBoxButtons.OK,
        ...
        private void FormDataStatusMahasiswa_ForClosed(object sender, EventArgs e)
        {
